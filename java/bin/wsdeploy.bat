...
rem
rem $Id: wsdeploy.bat,v 1.8 2005/06/08 09:52:52 rameshm Exp $
rem ---------------------------------------------------------------------------
...
"%JAVA_HOME%\bin\java.exe" -Djava.endorsed.dirs="%JWSDP_HOME%\jaxp\lib;%JWSDP_HOME%\jaxp\lib\endorsed" -classpath  %PRG%\..;%PRG%\..\..\..\jwsdp-shared\bin;"%PATH%" LauncherBootstrap -verbose wsdeploy %CMD_LINE_ARGS%
